                ...
                <div class="card-body">
                    <form action="{{ route('image.save') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input class="{{ $errors->has('image_path') ? 'is-invalid' : ''}}" id="image_path" type="file" name="image_path">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea id="description" type="text" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : ''}}"></textarea>
